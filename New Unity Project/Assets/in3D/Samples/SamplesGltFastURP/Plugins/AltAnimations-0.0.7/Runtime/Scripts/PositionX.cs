...
{
    [CreateAssetMenu(fileName = "PositionXAnimation", menuName = "AltAnimations/PositionX", order = 2)]
    [System.Serializable]
    public class PositionX : AltAnimation
    {
        [SerializeField] 
        private float start;
        [SerializeField] 
        ...
        {
            _finish = First.position.x + finish;
        }
        ...
        protected override void Interpolate()
        {
            foreach (var trans in Components.Cast<Transform>())
            {
                ...
                trans.position = new Vector3(Mathf.Lerp(_start, _finish, Progress), pos.y, pos.z);
            }
        }
