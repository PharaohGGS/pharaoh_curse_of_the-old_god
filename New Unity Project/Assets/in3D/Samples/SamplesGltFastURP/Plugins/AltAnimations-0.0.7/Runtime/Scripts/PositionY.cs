...
{
    [CreateAssetMenu(fileName = "PositionYAnimation", menuName = "AltAnimations/PositionY", order = 2)]
    [System.Serializable]
    public class PositionY : AltAnimation
    {
        [SerializeField] 
        private float start;
        [SerializeField] 
        ...
        {
            _finish = First.position.y + finish;
        }
        ...
        protected override void Interpolate()
        {
            foreach (var trans in Components.Cast<Transform>())
            {
                ...
                trans.position = new Vector3(pos.x, Mathf.Lerp(_start, _finish, Progress), pos.z);
            }
        }
