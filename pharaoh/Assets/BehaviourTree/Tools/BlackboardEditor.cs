...
namespace BehaviourTree.Tools
{
    ...
    public class BlackboardEditor : Editor
    {
        ...
        {
            _dataListProperty = serializedObject.FindProperty("valueData");
            Debug.Log($"Found property valueData : {(_dataListProperty != null ? "List<dynamic>" : "NULL")}");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            Debug.Log($"valueData.size : {_listSize}");
            ...
            for (int i = 0; i < _dataListProperty.arraySize; i++)
            {
                ...
                Debug.Log($"valueData[{i}].type : {listRef.type}");
